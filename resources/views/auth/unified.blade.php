...
<div class="py-5 d-flex align-items-center position-relative overflow-hidden" style="min-height: 85vh; background: var(--deen-bg-canvas, #fbfbfd);">
    ...
    <div class="container position-relative" style="max-width: 520px; z-index: 1;">
        ...
        <div class="text-center mb-4">
            <a href="{{ route('store.index') }}" class="d-inline-flex align-items-center gap-2 mb-2 text-decoration-none">
                <img src="{{ asset('images/deen-logo-dark.png') }}" class="deen-brand-logo" style="height: 42px;" alt="DEEN" onerror="this.src='https://deencommerce.com/wp-content/uploads/2025/04/cropped-Deen-Logo-scaled-1.png'">
                <div class="deen-brand-lockup d-flex align-items-baseline">
                    ...
                    <span class="deen-domain-badge" style="font-size: 1.35rem;"><span class="deen-domain-dot">.</span>im</span>
                </div>
            </a>
        ...
        <div class="deen-frame p-4 p-md-5 shadow-lg bg-white position-relative" style="border-radius: var(--deen-radius-xl, 20px);">
            ...
            <div class="bg-light p-1 rounded-pill d-flex mb-4 border" style="border-color: var(--deen-border-hairline) !important;">
            ...
            <div class="text-center mt-4 pt-3 border-top" style="border-color: var(--deen-border-hairline) !important;">
                <div class="d-inline-flex align-items-center gap-3 text-muted small" style="font-size: 0.72rem;">
